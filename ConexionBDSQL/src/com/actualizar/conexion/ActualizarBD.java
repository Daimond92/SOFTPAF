package com.actualizar.conexion;
        ...
        //Creación de la clase para Actualizar BD
public class ActualizarBD {
        ...
        public ActualizarBD (){
            try {
                ...
                String query = "UPDATE clientes SET Nombre_cliente = '' WHERE FID_cliente = ";
                st.executeUpdate(query);//metodo de actualización de información
                System.out.println("Se actualizo información");
